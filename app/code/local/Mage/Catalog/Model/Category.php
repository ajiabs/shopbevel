...
//        }
	...
	/**
	 *Script to resize category image
	 *
	 *@returns string image
	 */
	 public function getResizedImage($size = "small", $quality = 100) {
		...
		$imageResized = Mage::getBaseDir ( 'media' ) . DS . "catalog" . DS . "product" . DS . "cache" . DS . "cat_resized" . DS . $resizePrefix. $this->getImage ();// Because clean Image cache function works in this folder only
		...
		if(file_exists($imageResized))
		{
			...
			return Mage::getBaseUrl ( 'media' ) ."/catalog/product/cache/cat_resized/" . $resizePrefix . $this->getImage();
		}
		else
		{
