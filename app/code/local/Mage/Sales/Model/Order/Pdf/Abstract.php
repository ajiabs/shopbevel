...
abstract class Mage_Sales_Model_Order_Pdf_Abstract extends Varien_Object
{
    ...
    {
        $font = Zend_Pdf_Font::fontWithPath(Mage::getBaseDir() . '/lib/Courier/courier-regular.ttf');
    ...
    {
        $font = Zend_Pdf_Font::fontWithPath(Mage::getBaseDir() . '/lib/Courier/courier-bold.ttf');
        $object->setFont($font, $size);
        return $font;
    }
    ...
    {
        $font = Zend_Pdf_Font::fontWithPath(Mage::getBaseDir() . '/lib/Courier/courier-italic.ttf');
        $object->setFont($font, $size);
        return $font;
    }
