...
abstract class Mage_Sales_Model_Order_Pdf_Items_Abstract extends Mage_Core_Model_Abstract
{
    ...
    {
        $font = Zend_Pdf_Font::fontWithPath(Mage::getBaseDir() . '/lib/LektonFont/Lekton-Regular.ttf');
    ...
    {
        $font = Zend_Pdf_Font::fontWithPath(Mage::getBaseDir() . '/lib/LektonFont/Lekton-Bold.ttf');
        $this->getPage()->setFont($font, $size);
        return $font;
    }
    ...
    {
        $font = Zend_Pdf_Font::fontWithPath(Mage::getBaseDir() . '/lib/LektonFont/Lekton-Italic.ttf');
        $this->getPage()->setFont($font, $size);
        return $font;
    }
