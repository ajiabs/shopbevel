 ...
 *
 */
class Pixafy_CIM_Block_Payment_Info extends Mage_Core_Block_Template
{
    /**
    ...
    {
        parent::_construct();
        $this->setTemplate('cim/payment/info.phtml');
    }
    ...
    {
		if(!count($this->_purchaseData)){
			$d = ($this->getInfo()->getData());
			$quote = Mage::getSingleton('checkout/session')->getQuote();
			$paymentData = $quote->getPayment()->getData();
			$this->_purchaseData['Card Type'] 		= 	$d['cc_type'];
			$this->_purchaseData['Last four'] 		= 	$d['cc_last4'];
			$this->_purchaseData['Exp Month']		=	$d['cc_exp_month'];
			$this->_purchaseData['Exp Year']		=	$d['cc_exp_year'];
		}
