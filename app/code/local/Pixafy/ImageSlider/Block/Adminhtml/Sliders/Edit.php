 ...
 */
class Pixafy_ImageSlider_Block_Adminhtml_Sliders_Edit extends Mage_Adminhtml_Block_Widget
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('product_edit');
        Mage::register('pixafy_imageslider', Mage::getModel('imageslider/sliders')->load($this->getRequest()->getParam('id')));
    }
    ...
    {
        $header = 'Edit Slider (ID: '.$this->getRequest()->getParam('id').')';
        return $header;
    }
