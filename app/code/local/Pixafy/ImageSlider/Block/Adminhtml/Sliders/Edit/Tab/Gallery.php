<?php
class Pixafy_ImageSlider_Block_Adminhtml_Sliders_Edit_Tab_Gallery extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getContentHtml()
    {
        ...
        $content = Mage::getSingleton('core/layout')
            ->createBlock('imageslider/adminhtml_sliders_edit_tab_gallery_content');
