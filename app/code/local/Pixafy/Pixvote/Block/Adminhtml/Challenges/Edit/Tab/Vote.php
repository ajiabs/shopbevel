 ...
 */
class Pixafy_Pixvote_Block_Adminhtml_Challenges_Edit_Tab_Vote extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		$this->setForm($form);
		$fieldset = $form->addFieldset('pixvote_form', array('legend' => Mage::helper('pixvote')->__('Vote Time')));
