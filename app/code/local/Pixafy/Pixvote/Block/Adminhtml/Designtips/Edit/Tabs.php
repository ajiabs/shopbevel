<?php
class Pixafy_Pixvote_Block_Adminhtml_Designers_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	public function __construct()
	{
		...
		$this->setTitle(Mage::helper('pixvote')->__('Designers'));
	}
	...
	protected function _beforeToHtml()
	{
		...
		*/
		$this->addTab('form_edit_edit', array(
			'label'		=>	Mage::helper('pixvote')->__('Edit Designer'),
			'title'		=>	Mage::helper('pixvote')->__('Edit Designer'),
			'content'	=>	$this->getLayout()->createBlock('pixvote/adminhtml_designers_edit_tab_form')->toHtml(),
		));
