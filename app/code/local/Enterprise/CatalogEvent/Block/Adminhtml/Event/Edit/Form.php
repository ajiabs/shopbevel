 ...
 * PIXAFY
 * 
 * Override to change the label of CatalogEvent Form label: 'Sort Order' to 'Featured'
 * 
*/
...
class Enterprise_CatalogEvent_Block_Adminhtml_Event_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('sort_order', 'text', array(
                'label' => Mage::helper('enterprise_catalogevent')->__('Featured (1 = Featured Trunk Show)'),
                'name'  => 'sort_order',
