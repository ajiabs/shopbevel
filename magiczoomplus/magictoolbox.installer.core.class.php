<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.7.3' || 'working' == 'v4.0.32') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=commercial&tool_version=v4.0.32&module_version=v4.7.3&platform_name=magento&platform_version={$platformVersion}&url={$url}";
